...
const defaultConfig: AppConfig = {
  title: "Land Phone AI",
  description: "Voice Agent for Land Phone",
  settings: {
    editable: true,
    theme_color: "cyan",
    chat: true,          // show/hide chat panel
    inputs: {
      camera: false,     // hide camera section
      screen: false,     // hide screen share
      mic: true,         // keep microphone
    },
    outputs: {
      audio: true,       // keep audio visualizer
      video: false,      // hide video panel
    },
  },
  show_qr: false,
};
